...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='class', 
        title="Total Launch Success for Site")
        return fig
...
def get_scatter_plot(payload_slider, site):
    prange = payload_slider
    if site == 'ALL':
        fig = px.scatter(spacex_df, x= "Payload Mass (kg)", y = "class",
        color = "Booster Version Category",
        title='Payload mass by success for all sites')
        ...
        color = "Booster Version Category",
        title='Payload mass by success for site')
        fig.update_xaxes(range=prange)
        return fig
# Run the app
